        ...
        if (IQ.Type.get.equals(packet.getType())) {
            ...
            try {
                ...
                if (iqElement.element("remove") != null) {
                    ...
                    String email = null;
                    String name = null;
                    String phone=null;	//gjy
                    String birthday=null;	//gjy
                    String job=null;	//gjy
                    int sex=0; 	//gjy
                    ...
                    if (formElement != null) {
                        ...
                        phone=iqElement.elementText("phone");	//gjy
                        birthday=iqElement.elementText("birthday");
                    ...
                    //gjy
                    if(birthday!=null&&birthday.matches("\\s*")){
                    	birthday=null;
                    }  //gjy
